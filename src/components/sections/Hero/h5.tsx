...
export default function Hero() {
  ...
  return (
    <div
      ref={heroRef}
      className="h-[100vh] mx-auto pb-40 flex flex-col justify-end items-start px-20"
    >
      <div>
        <div className="hero-title text-heading-3 text-text-white">
          Worldpin.
        </div>
        <div className="hero-title text-heading-3 text-text-secondary">
          The Ultimate AI
        </div>
        <div className="hero-title text-heading-3 text-text-secondary">
          Wearable for Web3.
      ...
      <div className="mt-16 max-w-full">
        <div className="hero-subtitle text-lg text-text-white">
